...
function player.movimenta(medidaMoviemento,dt)
  player.controlaCdSkill(dt)
  if(player.status == 'caminhando') then
    player.sleepTime = player.sleepTime + dt * 3
    if(player.sleepTime > 0.1) then   
    if k("down") and player.colisaoBorda(player.getPosX(),player.getPosY(),player.getWidth(),player.getHeight(),"down") then
        if(player.direcao == 'down') then
            player.pos = player.pos + 1
            player.posMax = maxPosicaoCorrida
            player.setPosY(player.getPosY() + (medidaMoviemento * 10)* dt)
          else
            player.pos = 1
            player.direcao = 'down'
            player.posMax = maxPosicaoCorrida
      ...
      elseif k("up") and player.colisaoBorda(player.getPosX(),player.getPosY(),player.getWidth(),player.getHeight(),"up") then
        if(player.direcao == 'up') then
            player.pos = player.pos + 1
            player.posMax = maxPosicaoCorrida
            player.setPosY(player.getPosY() - (medidaMoviemento * 10)* dt)
      ...
      elseif k("right") and player.colisaoBorda(player.getPosX(),player.getPosY(),player.getWidth(),player.getHeight(),"right") then
        if(player.direcao == 'right') then
            player.pos = player.pos + 1
            player.posMax = maxPosicaoCorrida
            player.setPosX(player.getPosX() + (medidaMoviemento * 10)* dt)
        else
            player.pos = 1
      ...
      elseif k("left") and player.colisaoBorda(player.getPosX(),player.getPosY(),player.getWidth(),player.getHeight(),"left") then
...
function player.colisaoBorda(posX,posY,width,height,direcao)
...
function player.update(medidaMoviemento,dt)
  player.movimenta(medidaMoviemento,dt)
